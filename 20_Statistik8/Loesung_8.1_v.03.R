...
##k-means-Clusteranalyse (zun?chst mit nicht-standardisierten Werten)
...
###########################################################################
#Das gleiche fuer standardisierte Werte
###########################################################################
...
#File fuer ANOVA (Originaldaten der Vorfaelle, nicht die z-transformierten)
