...
Für die heutige Übung brauchst du den Datensatz [temperature_2005.csv](https://github.com/ResearchMethods-ZHAW/datasets/raw/main/infovis/temperature_2005.csv). Dabei handelt es sich wieder um Teperaturwerte verschiedener Stationen, diesmal aus dem Jahr 2005. Das Datum ist so formatiert, dass `R` (isbesondere `read_csv`) es korrekt als `datetime` erkennen und als `POSIXct` einlesen sollte.
...
if(!file.exists("temperature_2005.csv")){
  download.file("https://github.com/ResearchMethods-ZHAW/datasets/raw/main/infovis/temperature_2005.csv","temperature_2005.csv")
  }
if(!file.exists("temperature_2005_metadata.csv")){
  download.file("https://github.com/ResearchMethods-ZHAW/datasets/raw/main/infovis/temperature_2005_metadata.csv","temperature_2005_metadata.csv")
  }
```
...
Lade anschliessend [temperature_2005_metadata.csv](https://github.com/ResearchMethods-ZHAW/datasets/raw/main/infovis/temperature_2005_metadata.csv) herunter und verbinde die beiden Datensätze mit einem `left_join` via `station` (bzw. `stn`). 
