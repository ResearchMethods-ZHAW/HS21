...
arrows(0, 0, spe.sc1[, 1] * 0.92,spe.sc1[, 2] * 0.92,length = 0, 
       lty = 1, col = "red")
...
dev.new(title = "RDA scaling 1 and 2 + lc",width = 7,height = 6,noRStudioGD = TRUE)
par(mfrow = c(1, 1))
# Scaling 2
plot(spe.rda, display = c("sp", "lc", "cn"), 
     main = "Triplot RDA spe.hel ~ env2 - scaling 2 - lc scores")
...
dev.new(title = "RDA scaling 1 and 2 + wa",width = 14,height = 6,noRStudioGD = TRUE)
par(mfrow = c(1, 2))
...
dev.new(title = "RDA plot with triplot.rda",width = 14,height = 6, noRStudioGD = TRUE)
par(mfrow = c(1, 2))
...
# Scaling 1
dev.new(title = "Partial RDA",width = 14,height = 6,noRStudioGD = TRUE)
par(mfrow = c(1, 2))
