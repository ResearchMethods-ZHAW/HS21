...
#plot(o.ca$CA$u, asp=1) Vorschlag stefan weglassen dann werden umweldaten ergänzt in Plot mit selektierten Arten
plot(ev,add=T,cex=0.8)

#Plot response surfaces to CA
plot(ca$CA$u, asp=1)
...
#The same with DCA (does not work because detrending destroys distance matrix)
