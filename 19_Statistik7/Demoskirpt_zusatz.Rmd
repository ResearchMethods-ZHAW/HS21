...
snames
sx <- o.ca$CA$v[sel.spec,1]
sy <- o.ca$CA$v[sel.spec,2]
plot(o.ca$CA$u, asp=1)
points(sx,sy,pch=16)
snames <- make.cepnames(snames)
text(sx,sy,snames,pos=c(1,2,1,1,3,2,4,3,1),cex=0.8)

#Plot post-hoc fitted environmental variables
sel.sites <- c("pH.peat", "Acidity.peat", "CEC.peat", "P.peat", "Waterlev.max")
o.ev <-envfit(o.ca,ssit[,sel.sites])
plot(o.ca$CA$u, asp=1)
plot(o.ev,add=T,cex=0.8)

#Plot response surfaces to CA
plot(o.ca$CA$u, asp=1)
ordisurf(o.ca,ssit$pH.peat,add=T)

plot(o.ca$CA$u, asp=1)
ordisurf(o.ca,ssit$Waterlev.av,add=T,col="blue")
...
ordisurf(o.dca,ssit$pH.peat,add=T)
ordisurf(o.dca,ssit$Waterlev.av,add=T,col="blue")

#The same with NMDS
mde <-vegdist(sveg,method="euclidean")
o.mmds<-metaMDS(mde,k=2)
plot(o.mmds$points)
#ordisurf(o.imds,ssit$pH.peat,add=T)
#ordisurf(o.imds,ssit$Waterlev.av,add=T,col="blue")
