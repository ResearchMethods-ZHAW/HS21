---
title: Musterloesung Aufgabe 5.2S GLMM
...
nova <- read_delim("https://zenodo.2017_ZHAW_individual_menu_sales_NOVANIMAL.csv?download=1", delim = ";", locale = locale(encoding = "latin1"))
