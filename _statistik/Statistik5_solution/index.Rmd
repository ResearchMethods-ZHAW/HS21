---
title: Loesung Aufgabe 5
output: distill::distill_article
categories:
- Statistik5
---

```{r export files echo = FALSE}
#export files
knitr::purl("_statistik/Statistik5_solution/index.Rmd", here::here("_statistik/Statistik5_solution/Solution_stat5.R"), documentation = 0)
# rmarkdown::render(input = "index.rmd", output_format = "pdf_document", output_file = here::here("_statistik/Statistik1_solution/Solution_stat1.pdf"))

```

>Download [R-Skript](_statistik/Statistik5_solution/Solution_stat5.R) 
...
```{r prepare data and define model, error=FALSE}
...
#not working yet
df %>% dplyr::select(ccrs, label_content) %>% pivot_wider(names_from = "ccrs", values_fill = "label_content") -> tt
...
```{r print results coefficients, message=FALSE, echo=FALSE}
...
```{r print results OR, message=FALSE, echo=FALSE}
