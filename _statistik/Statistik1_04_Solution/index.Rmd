...
```{r echo = FALSE}
#export files
knitr::purl("index.Rmd", Solution_stat1.R", documentation = 0)
...
xtabs(~ gender + milkcon ,data = nova) # da es in diesem fall keine kriteriumsvariable gibt, fehlt das y sozusagen
