---
title: Musterlösung Aufgabe 4.1
output: 
...
knitr::purl("solution_stat4.1.Rmd", "Statistik_4_Solution_4.1.R", documentation = 0)
```


## Musterloesung Aufgabe 4.1: Nicht-lineare Regression

- [R-Code als Download](Statistik_2_Solution_4.1.R)
- [Loesungstext Beispiel](Statistik_Loesung_4.1_v.02.pdf)
...
### Uebung 4.1 - Nicht-lineare Regression -- Loesung
