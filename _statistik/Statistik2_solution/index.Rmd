...
knitr::purl("index.Rmd", here::here("_statistik/Statistik2_solution/Solution_stat2.R"), documentation = 0)
rmarkdown::render(input = "index.rmd", output_format = "pdf_document", output_file = here::here("_statistik/Statistik2_solution/Solution_stat2.pdf"))
