...
```{r echo = FALSE}
#export files
knitr::purl("_statistik/Statistik1_solution/index.Rmd", here::here("_statistik/Statistik1_solution/Solution_stat1.R"), documentation = 0)
...
##kommentierte Loesung
```{r load data, message=T, purl = F, include=FALSE}
...
#Chi-squared Test
chi_sq <- chisq.test(nova2$gender, nova2$milkcon)
chi_sq

#Fisher's Test nur mit 2X2 Kontingenztabelle möglich
fisher.test(nova2$gender, nova2$milkcon)
```
...
```{r plot results, purl=F, message=T, echo = F,  fig.cap="Die wöchentlichen Verkaufszahlen für die Interventions- und Basiswochen unterscheiden sich nicht signifikant.", out.width = "80%"}
...
ggplot2::ggsave(filename = here::here("_statistik/Statistik1_solution/distill-preview.png"),
                device = "png")
