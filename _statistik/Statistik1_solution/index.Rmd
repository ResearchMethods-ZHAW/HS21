...
```{r echo = FALSE}
#export files
knitr::purl("index.Rmd", here::here("_statistik/Statistik1_solution/Solution_stat1.R"), documentation = 0)
...
>Download [R-Skript](Solution_stat1.R)

>Download [PDF](Solution_stat1.pdf)
...
> Meine Leseempfehlung Kapitel 2 von [Manny Gimond](https://mgimond.github.io/Stats-in-R/z_t_tests.html) 
