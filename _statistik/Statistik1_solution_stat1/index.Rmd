...
nova <- read_delim("2017_ZHAW_aggregated_menu_sales_NOVANIMAL.csv", delim = ";")
...
nova_survey <- data.table::fread("https://zenodo.2019_ZHAW_vonRickenbach_cleaned_recorded_survey_dataset_NOVANIMAL_anonym.csv?download=1", sep = ";", encoding = "Latin-1") %>% 
