...
knitr::purl("_statistik/Statistik2_solution/solution.Rmd", here::here("_statistik/Statistik2_solution/Solution_stat2.R"), documentation = 0)
# rmarkdown::render(input = "_statistik/Statistik2_solution/index.rmd", output_format = "pdf_document", output_file = here::here("_statistik/Statistik2_solution/Solution_stat2.pdf"))
...
> Download [R-Skript](_statistik/Statistik2_solution/Solution_stat2.R)

<!-- Download [PDF](Solution_stat2.pdf) -->
...
```{r load data, message=FALSE, echo=FALSE, results='hide', warning=FALSE}
...
```{r model adaption and interpretation}
...
```{r plot results, echo=F, fig.cap="Die wöchentlichen Verkaufzahlen unterscheiden sich je nach Menüinhalt stark. Das Modell wurde mit den log-tranformierten Daten gerechnet.", tidy=TRUE}
...
```{r define model and check assumptions}
...
```{r post hoc tests and interpretation}
...
```{r plot results, message=F, echo=F, fig.cap="Box-Whisker-Plots der wöchentlichen Verkaufszahlen pro Menü-Inhalte. Kleinbuchstaben bezeichnen homogene Gruppen auf *p* < .05 nach Tukeys post-hoc-Test."}
...
ggsave("_statistik/Statistik2_solution/distill-preview.png",
       height = 12,
       width = 20,
       device = png)
