...
knitr::purl("index.Rmd", "Solution_stat2.2_2.3s.R", documentation = 0)
...
> Download [R-Skript](Solution_stat2.1_2.3s.R)
...
```{r load data 2.2, message=FALSE, echo=FALSE, results='hide', warning=FALSE}
...
```{r prepare data 2.2, message=FALSE}
...
```{r plot results 2.3s, echo=F, fig.cap="Die wöchentlichen Verkaufzahlen unterscheiden sich je nach Menüinhalt stark. Das Modell wurde mit den log-tranformierten Daten gerechnet.", tidy=TRUE}
...
```{r load data 2.3, message=FALSE, echo=FALSE, results='hide', warning=FALSE}
...
```{r prepare data 2.3, message=FALSE}
...
```{r plot results 2.2, message=F, echo=F, fig.cap="Box-Whisker-Plots der wöchentlichen Verkaufszahlen pro Menü-Inhalte. Kleinbuchstaben bezeichnen homogene Gruppen auf *p* < .05 nach Tukeys post-hoc-Test."}
