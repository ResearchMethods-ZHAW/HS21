---
title: Musterloesung Aufgabe 4.2S multiple logistische Regression
...
- Download [R-Skript](16_Statistik4/RFiles/solution_stat4.2s.R)
- Download [PDF](16_Statistik4/RFiles/solution_stat4.2s.pdf)
...
nova_survey <- read_delim("https://zenodo.2019_ZHAW_vonRickenbach_cleaned_recorded_survey_dataset_NOVANIMAL_anonym.csv?download=1", 
                          delim = ";",
...
```{r, message=FALSE, echo=FALSE,fig.cap="Konfusionsmatrix"}
knitr::kable(km)
```
