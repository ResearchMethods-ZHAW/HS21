...
```{r echo = FALSE}
#export files
knitr::purl("_statistik/Statistik4_solution/index.Rmd", here::here("_statistik/Statistik4_solution/Solution_stat4.R"), documentation = 0)
...
>Download [R-Skript](_statistik/Statistik4_solution/Solution_stat4.R) 



# Loesung 4.1: Nicht-lineare Regression


# Loesung 4.2N: Logistische Regression (NatWis)

# Loesung 4.2S: Multiple logistische Regression (SozWis)
...
```{r load data and packages, message=FALSE, echo=FALSE, results='hide', warning=FALSE}
...
```{r print results, message=FALSE, echo=FALSE,fig.cap="Konfusionsmatrix"}
knitr::kable(km)
```
