...
knitr::purl("solution_Stat_Beispiel.Rmd", "Statistik_2_Solution_Beispiel.R", documentation = 0)
```



## Musterloesung Beispiel
- Datensatz [decy.csv](https://github.com/ResearchMethods-ZHAW/datasets/raw/main/statistik/decay.csv)
- [RCode als Download](Statistik_2_Solution_Beispiel.R)
- [Loesungstext Beispiel](Statistik_Loesung_Beispiel_v.02.pdf)
...
_Die log-transformierte Variante rechts sieht sowohl im Boxplot als auch im #Histogramm viel symmetrischer/besser normalverteilt aus. Damit ergibt sich #dann folgendes lineares Modell_
