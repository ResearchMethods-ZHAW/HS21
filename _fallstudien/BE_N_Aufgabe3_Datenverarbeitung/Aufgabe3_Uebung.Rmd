---
title: "Daten(vor)verarbeitung Fallstudie WPZ Uebung"
description:
author:
  - name: Beni Sigrist
output:
...
df_team1 <- read_delim("Feldaufnahmen/Felderhebung Sihlwald Team 1 (türkis).csv", delim = ";")

df_team2 <- read_delim("Feldaufnahmen/Felderhebungen_Team2_gelb.csv", delim = ";")

# Achtung! Beim Datensatz des Teams 2 fehlen wichtige Infos, die wir für die weiteren Prozesschritte brauchen, welche? 
...
df_team4 <- read_delim("Feldaufnahmen/Felderhebung_Waldstruktur_Team4.csv", delim = ",")
...
# Die eingelesenen Datensaetze anschauen und versuchen zu einem Gesamtdatensatz verbinden. 
...
### - Einfuegen zusaetzliche Spalte pro Datensatz mit der Gruppenzugehoerigkeit (Team1-4) 
### - Spaltenumbenennung damit die Bezeichungen in allen Datensaetzen gleich sind und der Gesamtdatensatz zusammengefuegt werden kann
...
ggplot(df_with_LIDAR, aes(DG_os, DG_Baumschicht)) + geom_point() + stat_smooth(method = "lm")
