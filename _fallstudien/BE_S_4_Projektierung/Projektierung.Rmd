...
```{r eval=FALSE}
depo_start <- as.Date("YYYY-MM-DD") # hier das erste verfügbare Messdatum
depo_end <- ...                     # hier das letzte verfügbare Messdatum
```
...
__Hinweis:__ In manchen Kantonen beginnen die Ferien jeweils an einem Montag und enden an einem Freitag. De facto starten die Ferien aber an einem Samstag und enden an einem Sonntag. Dies ist bei den obenstehenden Daten berücksichtigt. Die Angegebenen Zeiträume können darum von den offiziellen Angaben abweichen.
