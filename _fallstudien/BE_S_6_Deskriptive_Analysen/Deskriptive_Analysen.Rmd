...
- Plottet den Verlauf der monatlichen Besuchszahlen an eurer Zählstelle. Auf der x-Achse steht dabei dabei Jahr und Monat (gespeichert im df _depo_m_), auf der y-Achse die monatlichen Besuchszahlen. Zeichnet auch die beiden Lockdown ein.
...
Machen die vier definierten Phasen überhaupt Sinn? Welche alternative Einteilung gäbe es?
Schaut euch den Verlauf der Besuchszahlen unter Aufgabe 1 an und passt allenfalls die Phasen nochmals an. Sicherlich bestehen bleibt die Phase Normal sowie diejenige der beiden Lockdowns. 

- Wie kann (und soll) also die Phase COVID noch aufgeteilt werden?
