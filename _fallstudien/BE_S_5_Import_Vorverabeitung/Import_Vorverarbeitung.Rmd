...
__Hinweis:__ Im Stundenformat zeigen die Werte um 11:00 die Zähldaten zwischen 11:00 und 12:00.
...
- Ebenfalls muss das Datum als solches definiert werden. Welches Format hat es (im Code: format = "XXX")?
...
- Prüft nun, wie die Struktur des data.frame (df) aussieht und ob alle NA Werte entfernt wurden. Stimmen alle Datentypen?
...
- Die Stundendaten müssen zu ganzen Tagen aggregiert werden. Macht das wiederum einer Pipe Bezieht folgende Gruppierungen (__group_by()__) mit ein: __Datum, Wochentag, Wochenende, KW, Monat, Jahr, Phase__. Summiert die Zählmengen separat (Total, IN, OUT) auf und speichert das Resultat unter depo_d
