...
Tipp: ich mache das nachgelagert, da ich die Erfahrung hatte, dass zu viele Operationen in einem Schritt auch schon mal etwas durcheinander erzeugen koennen. Hinweis II: Wir packen alle Phasen (normal, die beiden Lockdowns und Covid aber ohne Lockdown) in eine Spalte --> long ist schöner als wide.
...
- Die Stundendaten muessen zu ganzen Tagen aggregiert werden. Macht das wiederum mit piping. Bezieht folgende Gruppierungen mit ein: __Datum, Wochentag, Wochenende, KW, Monat, Jahr, Phase__
