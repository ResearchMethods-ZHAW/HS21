---
title: "Homeranges Fallstudie WPZ Uebung"
author: "B.Sigrist"
...
Rehe <- Rehe %>%
  mutate(UTC_DateTime = as.POSIXct(paste(UTC_Date, UTC_Time), format = "%Y-%m-%d %H:%M:%S"))
...
## Die Theorie zu Korrelation folgt erst 27.10. vormittags


```{r tidy=TRUE, echo=FALSE, message=FALSE, results="hide"}
