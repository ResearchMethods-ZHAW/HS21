...
_Perimeter des Wildnispark Zürichs mit den ungefähren Standorten von drei ausgewählten automatischen Zählstellen. (aus Datenschutzgründen sind Linien eingezeichnet. Die Zähler befinden sich an einem Punkt auf dieser Linie.)_
