...
Bei näher Betrachtung der Daten erkennt man, dass einige Personen wiederholt im Datensatz auftauchen. Eine weitere Analyse-Möglichkeit wäre, ein Random-Intercept-Modell zu rechnen, welches jedes Individuum berücksichtigt (siehe Lösungsteil).     