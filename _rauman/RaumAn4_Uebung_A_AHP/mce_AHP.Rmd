...
```{r criteria-normalize, fig.cap="Normalizing the criteria so that each column equals to 1"}
...
```{r weights-normalize, fig.cap="Normalizing the weights so that the sum of all weights equals to 1"}
...
3. Calculate $\lambda_{max}$ by dividing the result of 2) by the number of criteria
