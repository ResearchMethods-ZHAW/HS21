...
raster_settlements <- rasterize(vect(settlements), r, field = 1) 
raster_protected_areas <- rasterize(vect(protected_areas), r, field = 1) 
raster_forests <- rasterize(vect(forests), r, field = 1) 
raster_streets <- rasterize(vect(streets), r, field = 1) 
