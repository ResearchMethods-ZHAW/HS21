...
#Raster data
eis25m <- rast("eis25m.tif") %>% mask(kt_schwyz)
#use mask() to only get data inside of study area
dhm25m <- rast("dhm25m.tif") %>% mask(kt_schwyz) #use mask() to only get data inside of study area
wind25m <- rast("wind25m.tif") %>% mask(kt_schwyz) #use mask() to only get data inside of study area
