...
```{r solutionEx1, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
knitr::include_graphics("images/exclusion_areas.png")
```

```{r solutionEx2, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r solutionEx3, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
knitr::include_graphics("images/d_to_settlements.png")
```

```{r solutionEx4, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
knitr::include_graphics("images/d_to_settlements_reclassified.png")
```

```{r solutionEx5, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r solutionEx6, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
knitr::include_graphics("images/weighted_overlay.png")
```

```{r solutionEx7, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r figfinalresults, echo=FALSE, fig.cap="Potential sites for wind power plants in Kt. Schwyz -- Spatial Resolution of 25m (red = less suitable, green = more suitable)", fig.align="center", out.width="80%", purl = FALSE}
knitr::include_graphics("images/potential_sites.png")
```

```{r  solutionEx8, echo=FALSE, message=FALSE, warning=FALSE, include=FALSE}
