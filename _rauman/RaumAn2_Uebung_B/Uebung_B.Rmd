...
```{r, layout = "l-page", message=FALSE, warning=FALSE, fig.cap="Stickstoffdioxid (NO2) in μg/m3, Interpoliert über die ganze Schweiz mit der Inverse Distance Weighted Methode. Die verschiedenen Plots zeigen die Veränderung der Interpolation bei steigendem IDP-Wert"}
library(purrr)
library(tidyr)
...
```{r, echo = TRUE, fig.cap="Stickstoffdioxid (NO2) in μg/m3, Interpoliert über die ganze Schweiz nach der Nearest Neighbour Methode."}
ggplot() + 
  geom_sf(data = schweiz) +
