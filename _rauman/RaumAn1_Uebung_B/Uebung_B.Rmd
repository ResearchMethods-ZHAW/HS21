...
check_download(c("kantone.gpkg","bezirke.gpkg", "bodeneignung_skelett.gpkg", "bodeneignung_skelett.tif","wasserverfuegbarkeit_boden.gpkg"), "rauman")
```
...
library(sf)
library(ggplot2)
campus <- read_sf("RaumAnalyse/shapefiles/Flaechen.shp")
campus_punkte <- read_sf("RaumAnalyse/shapefiles/Punkte.shp")

read_sf("shp/Flaechen.shp")
