### Research Methods Statistik 4
### (c) Jürgen Dengler, 05.11.2019
...
setwd("S:/pools/n/N-zen_naturmanag_lsfm/FS_Vegetationsanalyse/Lehre (Module)/MSc. Research Methods/Statistik Dengler 2019/DataSets") #Beispiel
attach(loyn)
