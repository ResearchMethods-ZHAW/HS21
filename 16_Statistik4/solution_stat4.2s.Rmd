...
#### Methodenteil
Die Kriteriumsvariable "Fleischkonsum" ist eine binäre Variable. Demnach wird eine multiple logistische Regression mit den Prädiktoren "Alter", "Geschlecht" und "Hochschulzugehörigkeit" gerechnet. Die Modelldiagnostik und das pseudo-$R^2$ von 2% zeigen allerdings, dass das Modell nicht gut zu den empirischen Daten passt. Eine weitere Lösung könnten weitere statistische Methoden sein, welche besser zu den vorliegenden Daten passen (z.B. multinomiale logistische Regression, weitere Infos [hier](https://stats.idre.ucla.edu/r/dae/multinomial-logistic-regression/))
...
Bei näherer Betrachtung der Daten erkennt man, dass einige Personen wiederholt im Datensatz auftauchen (siehe card_num). Bei einer weiteren Analyse müssten die einzelne Individuen ebenfalls berücksichtigt werden z.B. als festen Effekt (z.B. GLMM, für mehr Infos [hier](https://bbolker.github.io/mixedmodels-misc/glmmFAQ.html) oder [hier](ncbi.nlm.nih.gov/pmc/articles/PMC5970551/)) oder durch eine weitere Methode wie z.B. multinomiale logistische Regression.
