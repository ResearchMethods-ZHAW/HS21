...
\DecValTok{1} \OperatorTok{-}\StringTok{ }\KeywordTok{pchisq}\NormalTok{(mod1}\OperatorTok{$}\NormalTok{deviance,mod1}\OperatorTok{$}\NormalTok{df.resid) }\CommentTok{# hochsignifikant, d.h. kein gutes Modell}
\end{Highlighting}
\end{Shaded}
