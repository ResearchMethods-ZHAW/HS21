...
#export R file
knitr::purl("index.Rmd", "Demo_Assoziationen_Konsolidierung1.R", documentation = 0)
...
>Download [R-Skript](Demo_Assoziationen_Konsolidierung1.R)
...
```{r prepare data and define model, message=FALSE, eval=TRUE}
#lade Daten
...
```{r prepare data and define model t-test, eval=TRUE}
#define dataset
cars <- mtcars
...
```{r dino example, always check out the plots but also the means, slopes ect., eval=FALSE}
