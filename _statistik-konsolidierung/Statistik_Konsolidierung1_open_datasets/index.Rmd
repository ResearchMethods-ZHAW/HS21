...
data_911 <- read_delim(here::here("_statistik-konsolidierung/Statistik_Konsolidierung1_open_datasets/911.csv"), delim = ",")
head(data_911)
...
<!-- ![](_statistik-konsolidierung/Statistik_Konsolidierung1_open_datasets/1_github.png){width=70%} -->
<!-- 3. Klickt mit der rechten Maustaste auf den Knopf "raw" -->
<!-- ![](_statistik-konsolidierung/Statistik_Konsolidierung1_open_datasets/2_github.png){width=70%} -->
...
star_wars <- read_delim("https://github.com/rfordatascience/tidytuesday/blob/master/data/2018/2018-05-14/week7_starwars.csv", delim = ",", col_names = T)
...
urlfile = "https://github.com/rfordatascience/tidytuesday/blob/master/data/2018/2018-05-14/week7_starwars.csv" # definiere zuerst die URL auf der R zugreifen soll
