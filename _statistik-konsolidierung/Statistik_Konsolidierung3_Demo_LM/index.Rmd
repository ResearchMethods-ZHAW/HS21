...
> Download [R-Skript](_statistik-konsolidierung/Statistik_Konsolidierung3_Demo_LM/Demo_LM_Konsolidierung3.R)



```{r load data and packages, message=FALSE, include=FALSE, purl=F}

knitr::opts_chunk$set(echo = TRUE, collapse=FALSE, message = FALSE, results = "hide", warning = FALSE)

library(tidyverse)
<<<<<<< HEAD
if (!require("rosetta")) install.packages("rosetta")
=======
...
=======
```{r prepare data for anova, message=FALSE, eval=FALSE}
>>>>>>> 83002ea7f3e2d069baf12d1119ec3ff7b6574cb9
# für mehr infos
...
=======
```{r define ANOVA with two factors}
>>>>>>> 83002ea7f3e2d069baf12d1119ec3ff7b6574cb9
