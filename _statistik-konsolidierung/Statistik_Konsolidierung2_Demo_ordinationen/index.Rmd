...
#TODO: check what you want to show, at the moment the output is very messi - easiest way, just add a picture and the download button

knitr::opts_chunk$set(echo = T, collapse=TRUE, message = FALSE, results = "hide", warning = FALSE)

#export files
knitr::purl("index.Rmd", "Demo_PCA_Konsolidierung2.R", documentation = 0)


```


> Download [R-Skript](Demo_PCA_Konsolidierung2.R)
...
```{r einfaches Beispiel mit Daten aus Wildi: visualisierung der methodik}
...
```{r zweites Beispiel aus Wildi 2013}
