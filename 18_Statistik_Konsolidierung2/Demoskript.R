# Research Methods Statistik-Vorlesung 2019
# Ordinationen 
...
#Erklaerte Varianz der Achsen in Prozent (sdev ist die Wurzel daraus)
E<-o.pca$sdev^2/o.pca$totdev*100
E
E[1:5]
...
#Stress = Soe = Abweichung der zweidimensionalen NMDS-Loesung von der originalen Distanzmatrix
