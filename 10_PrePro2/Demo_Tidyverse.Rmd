...
Wir Laden [wetter.rda](09_PrePro1/data/wetter.rda) von der letzten Übung.
...
Da kommt das ``tidyverse`wieder ins Spiel. Die Umformung von Tabellen *breit*->*lang* erfolgt mittels `tidyr`(siehe ^[http://r4ds.had.co.nz/tidy-data.html#gathering]). Auch dieses package funktioniert wunderbar mit piping (`%>%`). 
