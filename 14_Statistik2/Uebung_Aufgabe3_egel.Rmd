...
muss noch ausführlicher geschrieben werden!
...
# visuallisierung
ggplot(df, aes(x = label_content, y= na.omit(tot_sold))) + geom_boxplot(fill="lightgrey") + labs(x = "Men?-Inhalt", y = "verkaufte Men?s")

# modell 2: scheint besser zu den Daten zu passen
