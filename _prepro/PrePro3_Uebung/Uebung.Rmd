...
```
- angereichter Datensatz (join zw. wetter und metadaten für verschiedene stationen)
- mutate() conveniance variable (z.b. Monate, Jahr
- summarise group_by(moante), danach group_by(monate, jahr)
- pivot_wider

demo: 
- code patrick einbinden
- ggplot mit wide table demonstreren
