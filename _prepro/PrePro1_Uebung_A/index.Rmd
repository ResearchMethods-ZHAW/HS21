...
Importiere den Datensatz [order_52252_data.txt](order_52252_data.txt) (Rechtsklick -> Speichern Unter). Es handelt sich dabei um die stündlich gemittelten Temperaturdaten an verschiedenen Standorten in der Schweiz im Zeitraum 2000 - 2005. Wir empfehlen [`read_table()`]( http://r4ds.had.co.nz/data-import.html) anstelle von `read.table()`.

```{r, message = F}
# Lösung Aufgabe 4

wetter <- readr::read_table("order_52252_data.txt")
```
