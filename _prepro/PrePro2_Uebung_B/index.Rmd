...
Gegeben sind die Daten von drei Sensoren ([sensor1.csv](sensor1.csv), [sensor2.csv](10_PrePro2/data/sensor2.csv), [sensor3.csv](10_PrePro2/data/sensor3.csv)). Lade die Datensätze runter und lese sie ein.
...
Importiere die Datei [sensor_1_fail.csv](sensor_fail.csv) in `R`.
